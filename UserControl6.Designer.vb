...
Partial Class Form4regulatory
    ...
    Private Sub InitializeComponent()
        ...
        ' tb_last_name
        ' 
        tb_last_name.Anchor = AnchorStyles.None
        ...
        ' tb_phone_number
        ' 
        tb_phone_number.Anchor = AnchorStyles.None
        ...
        ' tbdepartment
        ' 
        tbdepartment.Anchor = AnchorStyles.None
        ...
        ' tb_birthdate
        ' 
        tb_birthdate.Anchor = AnchorStyles.None
        ...
        ' tbjob_dessignation
        ' 
        tbjob_dessignation.Anchor = AnchorStyles.None
        ...
        ' tbmunicipality
        ' 
        tbmunicipality.Anchor = AnchorStyles.None
        ...
        ' tbemployment_date
        ' 
        tbemployment_date.Anchor = AnchorStyles.None
        ...
        ' tbcity_province
        ' 
        tbcity_province.Anchor = AnchorStyles.None
        ...
        ' tbbarangay
        ' 
        tbbarangay.Anchor = AnchorStyles.None
        ...
        ' tb_middle_name
        ' 
        tb_middle_name.Anchor = AnchorStyles.None
        ...
        ' tb_first_name
        ' 
        tb_first_name.Anchor = AnchorStyles.None
